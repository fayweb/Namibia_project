...
ps <- readRDS("/Users/u_erazo/Documents/LABbook/2024/Namibia_sequencing/analysis/phyobjects/Namibia_samples_decont.rds")
...
```
To put this into context; out of the 62624 OTUs, 308 OTUs contain less than 10 reads, which is:
```{r}
print((308/62624)*100)
```
